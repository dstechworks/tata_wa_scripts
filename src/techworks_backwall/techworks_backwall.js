            ...
            if (isNaValueFoundHelper(x['AE Name']) && x['AE Mobile No']) {
                ...
                for (const aeNum of aeNumbers) {
                    ...
                    let obj = {
                        ...
                        "buttonUrl": `complaint.html?storename=${spaceCheckerHelper(x['Store Name'])}&name=${spaceCheckerHelper(x['AE Name'])}&number=${aeNum}&dhanushid=${x['Dhanush Id']}&branch=${x['Branch']}&deviceid=${x['Device ID']}&type=techworksBackwall`
                    }
            ...
            if (isNaValueFoundHelper(x['AE 2 Name']) && x['AE 2 Mobile No']) {
                ...
                for (const ae2Num of ae2Numbers) {
                    ...
                    let obj = {
                        ...
                        "tlNum": firstTlNum,
                        "storeNum": x['Store Number'],
                        "buttonUrl": `complaint.html?storename=${spaceCheckerHelper(x['Store Name'])}&name=${spaceCheckerHelper(x['AE 2 Name'])}&number=${ae2Num}&dhanushid=${x['Dhanush Id']}&branch=${x['Branch']}&deviceid=${x['Device ID']}&type=techworksBackwall`
                    }
            ...
            if (isNaValueFoundHelper(x['TL Name']) && x['TL Mobile No']) {
                ...
                for (const tlNum of tlNumbers) {
                    ...
                    let obj = {
                        ...
                        "dhanushId": x['Dhanush Id'] ? x['Dhanush Id'] : 'NA',
                        "storeNum": x['Store Number'],
                        "buttonUrl": `complaint.html?storename=${spaceCheckerHelper(x['Store Name'])}&name=${spaceCheckerHelper(x['TL Name'])}&number=${tlNum}&dhanushid=${x['Dhanush Id']}&branch=${x['Branch']}&deviceid=${x['Device ID']}&type=techworksBackwall`
                    }
